...
def affichage_solution():
    ...
    if aff_nombre.upper() != "O":
        ...
        print("Il existe ",nombre_disposition, "disposition(s) possible(s)")
        print("Le nombre de tatamis 2x1 utilisables pour ce dojo est :", nombre_tatamis(largeur_dojo,longueur_dojo) )

def affichage_solution_alt():
    """propose une solution alternative de dimensions moindre et le nombre de tatamis correspondant"""
    ...
    if aff_autre.upper() != "O":
        ...
        print("Il existe ",nombre_disposition, "disposition(s) possible(s) avec les dimensions : ",largeur_max,"x",longueur_max)
        print("Le nombre de tatamis 2x1 utilisables pour ce dojo est :", nombre_tatamis(largeur_max,longueur_max) )
