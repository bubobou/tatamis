...
\begin{adjustwidth}{-1.5cm}{0cm}
    ...
    {\setlength{\tabcolsep}{1.5 mm}
        ...
        \begin{testtabular}{|m{0.6cm}|m{5.5cm}|m{8cm}|m{2cm}|c|} \hline
            \rowcolor{tssteelblue} \textcolor{white}{id}                        & \textcolor{white}{Sujet}                                                                   & \textcolor{white}{Test d'acceptance }                                                                                            & \textcolor{white}{Méthode de test} & \textcolor{white}{Résultat} \\ \hline
            ...
            &                                                                                                 & Le nombre de solution du programme donne le même nombre de solution que le calcul de coordonnées Tatamis                                                         & Automatisé      & OK       \\ \hline
